...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2024 at 04:59 AM
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `birthday`, `address`, `contact_number`, `email`, `email_token`, `email_verified_at`, `password`, `remember_token`, `google_oauth_id`, `created_at`, `updated_at`) VALUES
(1, 'Angelica', 'Panganiban', NULL, NULL, NULL, 'admin@admin.com', '', NULL, 'admin123', NULL, NULL, '2024-12-10 03:59:22', NULL);
...
ALTER TABLE `invoices`
  ...
  ADD CONSTRAINT `invoices_ibfk_3` FOREIGN KEY (`service_id`) REFERENCES `services` (`id`) ON DELETE CASCADE;
COMMIT;
